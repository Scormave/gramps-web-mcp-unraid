...
|----------|-------|-------------|
| [gramps-web-mcp](templates/gramps-web-mcp.xml) | `ghcr.io/scormave/gramps-web-mcp:latest` | MCP server for Gramps Web over HTTP |
...
- [ ] `ghcr.io/scormave/gramps-web-mcp:latest` is public and pullable

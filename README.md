...
|----------|-------|-------------|
| [gramps-web-mcp](templates/gramps-web-mcp.xml) | `ghcr.io/scormave/gramps-web-mcp:1.0.6` | MCP server for Gramps Web over HTTP |
...
- [ ] `ghcr.io/scormave/gramps-web-mcp:1.0.6` is public and pullable
